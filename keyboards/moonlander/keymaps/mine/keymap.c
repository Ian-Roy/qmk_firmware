...
LT(DPAD,KC_BSPC), KC_A,  KC_S,    KC_D,    KC_F,    KC_G,  KC_LPRN,           KC_RPRN,  KC_H,    KC_J,    KC_K,    KC_L,    LT(SCRL, KC_SCLN), LT(DPAD, KC_QUOT),
 ...
 LT(SYMB,KC_GRV),WEBUSB_PAIR,A(KC_LSFT),TG(AWAY), TG(DPAD),  LCTL(KC_Z),    TD(TD_C_X),          RGB_TOG,   RGB_TOG, RGB_TOG, TD(TD_MAC2), TD(TD_MAC1),
    ...
    [AWAY] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, _______, _______,
        _______, KC_A   , KC_A   , KC_A   , _______, _______, _______,                     _______, _______, _______, _______, _______, _______, _______,
        _______, KC_A   , KC_A   , KC_A   , _______, _______, _______,                              _______, _______, _______, _______, _______, _______,
        _______, KC_A   , KC_A   , KC_A   , _______, _______,                                       _______, _______, _______, _______, _______, _______,
        _______, _______, _______,TG(AWAY), _______,          _______,                     _______,          _______, _______, _______, _______, _______,
                                            _______, _______, _______,                     _______, _______, _______,
    )
};
